...
import { BadRequestError, IAuthDocument, IEmailMessageDetails } from '@k0msak007/jobber-shared';
...
export async function resetPassword(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    if (!existingUser) {
      throw new BadRequestError('Reset token is expired', 'Password resetPassword() method error');
    }
